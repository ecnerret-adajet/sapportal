...
@section('content')
	...
	<h3>
	Functional Approval: Sap User Creation Form
	</h3>
	<em>
	...
	{!! Form::model($sapuserFunctional = new \App\SapuserFunctional, ['class' => 'form-horizontal', 'url' => 'sapusers/functional/'.$sapuser->id, 'enctype' => 'multipart\form-data']) !!}
