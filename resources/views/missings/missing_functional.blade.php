...
@section('content')
	...
	<h3>
	Functional Approver: Missing authorization form
	</h3>
	<em>
	...
	{!! Form::model($functional = new \App\Functional, ['class' => 'form-horizontal', 'url' => 'missings/functional/'.$missing->id, 'enctype' => 'multipart\form-data']) !!}
