...
class SapuserApproverToManagementSuccessNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
         return (new MailMessage)
                    ...
                    ->action('Visit the portal now',  url('/sapusers/management/create/'.$this->sapuserApprover->id))
